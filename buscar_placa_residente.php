...
if (empty($placa)) {
	...
	$sql = "SELECT e.placa, e.idtipo, t.tipo as tipo FROM entradas e, tipovehiculo t
			WHERE e.idtipo = t.idtipo AND e.placa LIKE '%$placa%' and e.idtipo = 2";
...
<body>
	<div class="container">
		<div class="row">
			<h1></h1>
			<form action="guardar_residente.php" method="post">
				...
				<div class="form-group col-8 mb-3">
					<button type="button" class="form-control btn btn-warning" name="guardar">
						<a href="alta_residente.php" color="white">Cancelar</a></button>					
				</div>
			</form>
		</div>
	</div>	
